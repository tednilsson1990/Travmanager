...
const EGNA = [
  ...
  `./ui-kontorvy.js?v=${VERSION}`,
  `./ui-prolog.js?v=${VERSION}`,
  `./ui-grafik.js?v=${VERSION}`,
  `./ui-hemvy.js?v=${VERSION}`,
  `./ui-journalvy.js?v=${VERSION}`,
  `./ui-scenvy.js?v=${VERSION}`,
  ...
  `./engine-lyssnare.js?v=${VERSION}`,
  `./engine-storlopp.js?v=${VERSION}`,
  `./engine-scener.js?v=${VERSION}`,
  ...
  `./engine-sponsor.js?v=${VERSION}`,
  `./engine-agare.js?v=${VERSION}`,
  `./engine-analys.js?v=${VERSION}`,
  `./engine-travblad.js?v=${VERSION}`,
  `./engine-proposition.js?v=${VERSION}`,
  `./engine-anmalan.js?v=${VERSION}`,
  `./engine-aitranare.js?v=${VERSION}`,
  `./engine-inkorg.js?v=${VERSION}`,
  `./engine-klocka.js?v=${VERSION}`,
  `./engine-minnen.js?v=${VERSION}`,
  `./engine-veckomote.js?v=${VERSION}`,
  `./engine-statistik.js?v=${VERSION}`,
  `./engine-varldsutveckling.js?v=${VERSION}`,
  `./ui-statistikvy.js?v=${VERSION}`,
  `./ui-inkorgvy.js?v=${VERSION}`,
  `./engine-vagvisare.js?v=${VERSION}`,
  `./engine-stallmote.js?v=${VERSION}`,
